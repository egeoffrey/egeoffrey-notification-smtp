...
```
egeoffrey-cli install egeoffrey-notification-smtp
```
...
```
egeoffrey-cli uninstall egeoffrey-notification-smtp
```
...
The version of this egeoffrey-notification-smtp is 1.0-14 on the master branch.
